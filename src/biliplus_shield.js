...
*/
var shield = (function () {
	var danmakuMatcher = /[\x00-\x2f\x3a-\x40\x5b-\x5e\x60\x7b-\x7f]/g, firstTime = !0, hidden = !0, list = null, activeTab = 0, useReg = !1, $ = function (a) {return playerInstance.playerUnit.querySelectorAll(a);}, $$ = function (a) {return playerInstance.playerUnit.querySelector(a);}, limit, playerInstance = null,
	...
	obj = {
		init: function (player) {
			...
			limit = list.limit;
			obj.render();
			$$('.shield-enrty').addEventListener('click', obj.show);
			$$('.shield_top .close').addEventListener('click', obj.show);
			$$('.shield_item .add').addEventListener('click', obj.add);
			var i, len, tabs;
			tabs = $('.shield_tab');
